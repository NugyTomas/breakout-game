class GameDimension:
    ...
    def __init__(self, width, height):
        ...
        self.game_state_font_size = int(self.scoreboard_font_size * 2.4)
        self.final_score_font_size = int(self.scoreboard_font_size * 1.2)
        self.retry_font_size = int(self.scoreboard_font_size * 1.1)
        self.countdown_font_size = int(self.scoreboard_font_size * 3)
